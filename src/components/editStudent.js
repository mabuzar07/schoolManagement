...
function EditStudent(props){
    const [registration, setRegistration] = React.useState(props.data.registration);
    const [name, setName] = React.useState(props.data.name);
    const [fatherName, setFatherName] = React.useState(props.data.fatherName);
    const [fatherCnic, setFatherCnic] = React.useState(props.data.fatherCnic);
    const [fatherPh, setFatherPh] = React.useState(props.data.fatherMobile);
    const [dob, setDob] = React.useState(props.data.dob);
    const [address, setAddress] = React.useState(props.data.address);
    const [bForm, setBform] = React.useState(props.data.bForm);
    const [stdClass, setStdClass] = React.useState(props.data.class);
    const [drop_out_date, setDropOutDate] = React.useState(props.data.drop_out_date);
    const [admissionDate, setAdmissionDate] = React.useState(props.data.admissionDate);
    const [isWithdraw, setIsWithDraw] = React.useState(props.data.isWithdraw == "false" ? "1" : "2");
    ...
    const validation = () => {
        if(registration == ""){
         ...
         if(stdClass == ""){
            ...
            formData.append("fatherPh",fatherPh)
            formData.append("dob",dob)
            formData.append("bForm",bForm)
            formData.append("className",stdClass)
            formData.append("isWithdraw",isWithdraw == 1 ? false : true)
            formData.append("image_url",image_url)
            formData.append("drop_out_date",drop_out_date)
    ...
    const studentUpdate = (data) =>{
        ...
        fetch(Constant.apiURl + "student/" + props.data.id, {
            method: "PUT",
            headers: {
                ...
                <div className="student-add card-container mt-4">
                    <div className="row">
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={registration} className={errorFor == "registration" ? "form-control is-invalid" : registration != "" ? "form-control is-valid" : "form-control"} id="regNo" onChange={(e) => { setRegistration(e.target.value); reset()}} aria-describedby="regNo" placeholder="Enter registration no" />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={name} className={errorFor == "name" ? "form-control is-invalid" : name !="" ? "form-control is-valid" : "form-control"} id="name" onChange={(e) => {setName(e.target.value);reset()}} aria-describedby="name" placeholder="Enter student name" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={fatherName} className={errorFor == "fatherName" ? "form-control is-invalid" : fatherName != "" ? "form-control is-valid" : "form-control"} id="fatherName" onChange={(e) => {setFatherName(e.target.value);reset()}} aria-describedby="fatherName" placeholder="Enter student father name" />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={fatherCnic} className={errorFor == "fatherCnic" ? "form-control is-invalid" : fatherCnic != "" ? "form-control is-valid" : "form-control"} id="fatherCnic" onChange={(e) => {setFatherCnic(e.target.value);reset()}} aria-describedby="fatherCnic" placeholder="Enter student father CNIC" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={fatherPh} className={errorFor == "fatherPh" ? "form-control is-invalid" : fatherPh != "" ? "form-control is-valid" : "form-control"} id="fatherPh" onChange={(e) => {setFatherPh(e.target.value);reset()}} aria-describedby="fatherPh" placeholder="Enter student father ph#" />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="date" value={dob} className={errorFor == "dob" ? "form-control is-invalid" : dob != "" ? "form-control is-valid" : "form-control"} id="dob" onChange={(e) => {setDob(e.target.value);reset()}} aria-describedby="dob" placeholder="Enter student dob" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" value={bForm} className={errorFor == "bForm" ? "form-control is-invalid" : bForm != "" ? "form-control is-valid" : "form-control"} id="bForm" aria-describedby="bForm" onChange={(e) => {setBform(e.target.value);reset()}} placeholder="Enter student B form#" />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <select value={stdClass} className={errorFor == "stdClass" ? "form-control is-invalid" : stdClass != "" ? "form-control is-valid" : "form-control"} id="classSelect" onChange={(e) => {setStdClass(e.target.value);reset()}}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="date" value={admissionDate} className={errorFor == "admissionDate" ? "form-control is-invalid" : admissionDate != "" ? "form-control is-valid" : "form-control"} id="admissionDate" onChange={(e) => {setAdmissionDate(e.target.value);reset()}} aria-describedby="dob" placeholder="Enter student admission date" />
                    ...
                    <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="date" value={drop_out_date} className={errorFor == "drop_out_date" ? "form-control is-invalid" : drop_out_date != "" ? "form-control is-valid" : "form-control"} id="drop_out_date" onChange={(e) => {setDropOutDate(e.target.value);reset()}} aria-describedby="dob" placeholder="Enter student drop out date" />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <textarea className={errorFor == "address" ? "form-control is-invalid" : address != "" ? "form-control is-valid" : "form-control"} id="address" value={address} onChange={(e) => { setAddress(e.target.value); reset()}} placeholder="Enter teacher address" ></textarea>
                    ...
                    <div className="d-flex justify-content-end">
                        <button type="button" className="btn button-bg" onClick={validation}>Edit Student</button>
                    </div>
                </div>
            </div>
    )
